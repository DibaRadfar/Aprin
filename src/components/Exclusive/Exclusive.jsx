...
export default function Exclusive() {
  const products = [
    ...
    { title: "چاپ کارت", img: "/imges/چاپ کارت .png", size: "w-[43.563rem] h-[12.938rem]" },
    ...
    <div className="Exclusive px-[2rem] mb-[3.75rem]">
      ...
      <div className="flex justify-between items-center w-full">
        <div className="flex gap-[0.5rem] items-center">
          ...
          <p className="text-[30px] font-semibold leading-none text-[#464646] font-vazir">
            محصولات اختصاصی
          </p>
        </div>
        <a
          href="#"
          className="flex items-center gap-[0.25rem] text-[20px] text-[#464646] font-vazir hover:text-[#E21761]"
        >
          مشاهده همه
      ...
      <div className="flex flex-col gap-[1.75rem] mt-[3.125rem]">
        ...
        <div className="flex flex-col md:flex-row gap-[2.313rem]">
          ...
          <div className="grid grid-cols-2 gap-[1.75rem] sm:grid-cols-2 md:grid-cols-2">
